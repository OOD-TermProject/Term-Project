...
public class Limousine extends TransportType{
    /**
     ...
     */
    public Limousine(String arrivalTime, String arrivalDate, Place destination, String departTime, float price, Place departFrom, String departDate) {
